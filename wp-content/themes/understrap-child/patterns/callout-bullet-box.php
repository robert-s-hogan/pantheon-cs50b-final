...
<div class="wp-block-group has-border-color" style="border-color:var(--wp--preset--color--primary);border-width:2px;padding:24px">
	...
	<ul style="line-height:1.6">
		<li>Fundraising events that directly benefit students</li>
		<li>Community-building activities for families &amp; staff</li>
		<li>Volunteer coordination and classroom support</li>
	</ul>
	<!-- /wp:list -->
</div>
<!-- /wp:group -->
