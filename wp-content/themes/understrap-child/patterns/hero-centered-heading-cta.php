...
<div class="wp-block-cover is-light" style="padding-top:80px;padding-bottom:80px;min-height:420px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size">Welcome to Our Community</h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","fontSize":"large"} -->
		<p class="has-text-align-center has-large-font-size">Supporting Students – Empowering Families</p>
		<!-- /wp:paragraph -->
