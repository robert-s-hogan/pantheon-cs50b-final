...
<div class="wp-block-cover is-light" style="padding-top:32px;padding-bottom:32px;min-height:120px">
	...
	<div class="wp-block-cover__inner-container">
		<!-- wp:paragraph {"align":"center","fontSize":"large","textColor":"background"} -->
		<p class="has-text-align-center has-background-color has-large-font-size">Ready to make a difference?</p>
		<!-- /wp:paragraph -->

		<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
		<div class="wp-block-buttons">
			<!-- wp:button {"backgroundColor":"background","textColor":"primary"} -->
			<div class="wp-block-button"><a class="wp-block-button__link has-primary-color has-background-background-color has-text-color has-background">Join&nbsp;Us</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
